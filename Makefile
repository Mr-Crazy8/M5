...
CC = cc
CFLAGS = -Wall  -I/mnt/homes/anel-men/.brew/opt/readline/include -fsanitize=address -g
...
LDLIBS = -L/mnt/homes/anel-men/.brew/opt/readline/lib -lreadline
